...
def run():
    # for every input we have in custom docker action, GHA adds an environment
    # variable prepended with INPUT_ and capitaised input param name
    ...
    # boto package helps in looking for AWS secrets going out of action
